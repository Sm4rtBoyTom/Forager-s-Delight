...
namespace ForagersDelightMod
{
    internal class Settings : JsonModSettings
    {
        ...
        [Section("Mod Support - DO NOT TURN ON UNLESS YOU HAVE THESE MODS INSTALLED!")]

        [Name("Camping Tools by Jods-Its")]
        [Description("Enables mod function for Camping Tools mod.")]
        public bool CampingTools = false;
        ...
        [Name("Nomad's Expedition by Maple-Sapling")]
        [Description("Enables mod function for Nomad's Expedition mod.")]
        public bool NomadsExpedition = false;
        ...
        [Name("Northfolk Clothing Pack by Waltz")]
        [Description("Enables mod function for Northfolk Clothing Pack mod.")]
        public bool Northfolk = false;

      /*  [Name("Bearskin Leggings")]
        [Description("Carry Weight Bonus in KG. Default - 0Kg")]
        [Slider(0f, 2f, 21)]
        public float BearskinLeggings = 0f;
      */
        ...
        { 
            ...
            if (instance.NomadsExpedition == true)
            {
            ...
            if (instance.Northfolk == true)
            {
                SetFieldVisible(nameof(instance.DeerskinCoat), true);
              //  SetFieldVisible(nameof(instance.BearskinLeggings), true);

            }
            else
            {
                SetFieldVisible(nameof(instance.DeerskinCoat), false);
            //    SetFieldVisible(nameof(instance.BearskinLeggings), false);
        ...
        public static void ApplyReset()
        {
            if (instance.ResetSettings == true)
            {
                ...
                //instance.BearskinLeggings = 0f;
                instance.Northfolk = false;
                instance.NomadsExpedition = false;
                instance.CampingTools = false;
            }
        }
    }
}
